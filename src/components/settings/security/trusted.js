        ...
        <div class="flex flex-row justify-between content-start items-center py-2 px-5 space-x-5 border-b  text-ntext">
          <div className=" flex items-center flex-row justify-between">
            ...
            <h1 className=" text-lg font-popins font-bold text-ntext">
              {" "}
              Trusted Beneficiaries for two steps Verification
            </h1>
          </div>
          <div className=" text-ntext cursor-pointer flex flex-row">
          ...
          {accountModal ? ( 
              ...
              <div className=" flex flex-col flex-grow w-full  py-4 items-start  px-6">
                <div className=" text-sm text-ntext font-semibold">
                  We two steps verification is turned on, you can set Trusted Beneficiaries when performin finacial actions
                </div>
                <div className=" text-ntext">What is trusted Beneficiaries?</div>
                ...
                <form action="">
                  <div className=" my-2  rounded-sm px-2 mx-5 py-4 md:px-5  flex flex-col justify-between  border-b ">
                    ...
                    <div className=" flex flex-col">
                      <div className=" text-ntext text-sm font-bold">
                        Password must contain
                      </div>
                      <div className=" text-ntext text-xs">
                        <span className=" font-bold">*</span> 1 or more Numbers
                        (0-9)
                      </div>
                      <div className=" text-ntext text-xs">
                        <span className=" font-bold">*</span> 1 or more letters
                        (a-z, A-Z)
                      </div>
                      <div className=" text-ntext text-xs">
                        <span className=" font-bold">*</span> 7 or more
                        Characters
                      </div>
                    </div>
                  </div>
